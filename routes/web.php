...
Route::get('/welcome',[PageController::class,'index'])->name('page');
...
Route::get('/bank_answer', function () {
    return view ('admin.variants.bank_answer');
})->name('bank_answer');

...
<style>
    ...
    <script>
        window.hs_config = {"autopath":"@@autopath","deleteLine":"hs-builder:delete","deleteLine:build":"hs-builder:build-delete","deleteLine:dist":"hs-builder:dist-delete","previewMode":false,"startPath":"/index.html","vars":{"themeFont":"https://fonts.googleapis.com/css2?family=Inter:wght@400;600&display=swap","version":"?v=1.0"},"layoutBuilder":{"extend":{"switcherSupport":true},"header":{"layoutMode":"default","containerMode":"container-fluid"},"sidebarLayout":"default"},"themeAppearance":{"layoutSkin":"default","sidebarSkin":"default","styles":{"colors":{"primary":"#377dff","transparent":"transparent","white":"#fff","dark":"132144","gray":{"100":"#f9fafc","900":"#1e2022"}},"font":"Inter"}},"languageDirection":{"lang":"en"},"skipFilesFromBundle":{"dist":["assets/admin/js/hs.theme-appearance.js","assets/admin/js/hs.theme-appearance-charts.js","assets/admin/js/demo.js"],"build":["assets/admin/css/theme.css","assets/admin/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js","assets/admin/js/demo.js","assets/admin/css/theme-dark.css","assets/admin/css/docs.css","assets/admin/vendor/icon-set/style.css","assets/admin/js/hs.theme-appearance.js","assets/admin/js/hs.theme-appearance-charts.js","node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js","assets/admin/js/demo.js"]},"minifyCSSFiles":["assets/admin/css/theme.css","assets/admin/css/theme-dark.css"],"copyDependencies":{"dist":{"*assets/admin/js/theme-custom.js":""},"build":{"*assets/admin/js/theme-custom.js":"","node_modules/bootstrap-icons/font/*fonts/**":"assets/admin/css"}},"buildFolder":"","replacePathsToCDN":{},"directoryNames":{"src":"./src","dist":"./dist","build":"./build"},"fileNames":{"dist":{"js":"theme.min.js","css":"theme.min.css"},"build":{"css":"theme.min.css","js":"theme.min.js","vendorCSS":"vendor.min.css","vendorJS":"vendor.min.js"}},"fileTypes":"jpg|png|svg|mp4|webm|ogv|json"}
...
<script src="{{asset('assets/admin/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js')}}"></script>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img" src="{{asset('assets/admin/svg/brands/google-icon.svg')}}" alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- End Col -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-body-height">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-xs avatar-4x3" src="{{asset('assets/admin/svg/brands/slack-icon.svg')}}" alt="Image Description">
                                            </div>
                                            <div class="flex-grow-1 text-truncate ms-3">
            ...
            <div class="col-6">
                <div class="form-check form-check-label-highlighter text-center">
                    ...
                    <label class="form-check-label mb-2" for="layoutSkinsRadio1">
                        <img class="form-check-img" src="{{asset('assets/admin/img/415x310/img1.jpg')}}" alt="Image Description">
                    </label>
            ...
            <div class="col-6">
                <div class="form-check form-check-label-highlighter text-center">
                    ...
                    <label class="form-check-label mb-2" for="layoutSkinsRadio2">
                        <img class="form-check-img" src="{{asset('assets/admin/img/415x310/img2.jpg')}}" alt="Image Description">
                    </label>
            ...
            <div class="col-6">
                <div class="form-check form-check-label-highlighter text-center">
                    ...
                    <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio1">
                        <img class="form-check-img" src="{{asset('assets/admin/svg/layouts-light/sidebar-default.svg')}}" alt="Image Description" data-hs-theme-appearance="dark">
                        <img class="form-check-img" src="{{asset('assets/admin/svg/layouts/sidebar-default.svg')}}" alt="Image Description" data-hs-theme-appearance="default">
                    </label>
                    <span class="form-check-text">Default</span>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="form-check form-check-label-highlighter text-center">
                    ...
                    <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio2">
                        <img class="form-check-img" src="{{asset('assets/admin/svg/layouts-light/sidebar-dark.svg')}}" alt="Image Description" data-hs-theme-appearance="dark">
                        <img class="form-check-img" src="{{asset('assets/admin/svg/layouts/sidebar-dark.svg')}}" alt="Image Description" data-hs-theme-appearance="default">
                    </label>
                ...
                <div class="container">
                    <div class="navbar-nav-wrap">
                        ...
                        <a class="navbar-brand" href="index.html" aria-label="Front">
                            <img class="navbar-brand-logo" src="assets/admin/svg/logos/logo-white.svg" alt="Logo">
                        </a>
                        <!-- End Logo -->
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-auto">
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="avatar avatar-sm avatar-circle">
                                                                                    <img class="avatar-img" src="assets/admin/svg/brands/google-icon.svg" alt="Image Description">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <!-- End Col -->
    ...
    <div class="offcanvas-body">
        ...
        <ul class="step step-icon-sm step-avatar-sm">
            ...
            <li class="step-item">
                <div class="step-content-wrapper">
                    <div class="step-avatar">
                        <img class="step-avatar" src="{{asset('assets/admin/img/160x160/img9.jpg')}}" alt="Image Description">
                    </div>
                            ...
                            <li class="list-group-item list-group-item-light">
                                <div class="row gx-1">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-xs" src="{{asset('assets/admin/svg/brands/word-icon.svg')}}" alt="Image Description">
                                            </div>
                                            <div class="flex-grow-1 text-truncate ms-2">
                                                <span class="d-block fs-6 text-dark text-truncate" title="weekly-reports.xls">weekly-reports.xls</span>
            ...
            <li class="step-item">
                <div class="step-content-wrapper">
                    <div class="step-avatar">
                        <img class="step-avatar-img" src="{{asset('assets/admin/img/160x160/img3.jpg')}}" alt="Image Description">
                    </div>
                    ...
                    <div class="step-content">
                        ...
                        <ul class="list-group list-group-sm">
                            <li class="list-group-item list-group-item-light">
                                <div class="row gx-1">
                                    <div class="col">
                                        <img class="img-fluid rounded" src="{{asset('assets/admin/svg/components/card-1.svg')}}" alt="Image Description">
                                    </div>
                                    <div class="col">
                                        <img class="img-fluid rounded" src="{{asset('assets/admin/svg/components/card-2.svg')}}" alt="Image Description">
                                    </div>
                                    <div class="col">
                                        <img class="img-fluid rounded" src="{{asset('assets/admin/svg/components/card-3.svg')}}" alt="Image Description">
                                    </div>
            ...
            <li class="step-item">
                <div class="step-content-wrapper">
                    <div class="step-avatar">
                        <img class="step-avatar-img" src="{{asset('assets/admin/img/160x160/img7.jpg')}}" alt="Image Description">
                    </div>
            ...
            <li class="step-item">
                <div class="step-content-wrapper">
                    <div class="step-avatar">
                        <img class="step-avatar-img" src="{{asset('assets/admin/img/160x160/img5.jpg')}}" alt="Image Description">
                    </div>
            ...
            <div class="modal-body p-sm-5">
                <div class="text-center">
                    <div class="w-75 w-sm-50 mx-auto mb-4">
                        <img class="img-fluid" src="{{asset('assets/admin/svg/illustrations/oc-collaboration.svg')}}" alt="Image Description" data-hs-theme-appearance="default">
                        <img class="img-fluid" src="{{asset('assets/admin/svg/illustrations-light/oc-collaboration.svg')}}" alt="Image Description" data-hs-theme-appearance="dark">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a class="d-flex align-items-center small text-body" href="#">
                            <img class="avatar avatar-xss avatar-4x3 me-2" src="{{asset('assets/admin/svg/brands/gmail-icon.svg')}}" alt="Image Description">
                            Import contacts
                        </a>
                    </div>
                </div>
                ...
                <ul class="list-unstyled list-py-2 mb-0">
                    ...
                    <li>
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{asset('assets/admin/img/160x160/img3.jpg')}}" alt="Image Description">
                                </div>
                            </div>
                    ...
                    <li>
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{asset('assets/admin/img/160x160/img9.jpg')}}" alt="Image Description">
                                </div>
                            </div>
